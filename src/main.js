...
function showMeiQuestion() {
  ...
  appContent.innerHTML = `
    <div class="quiz-container">
        <div class="quiz-progress"><ruby>七月<rt>しちがつ</rt></ruby>の<ruby>銘<rt>めい</rt></ruby>クイズ: <ruby>第<rt>だい</rt></ruby> ${currentQuestionIndex + 1} <ruby>問<rt>もん</rt></ruby> / 10</div>
...
function showResult(type) {
  ...
  if (type === 'quiz') {
    ...
    title = '<ruby>七月<rt>しちがつ</rt></ruby>の<ruby>銘<rt>めい</rt></ruby>クイズ <ruby>修了<rt>しゅうりょう</rt></ruby>';
